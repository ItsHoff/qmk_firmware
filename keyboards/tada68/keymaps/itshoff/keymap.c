...
// Shift-alt mod-tap
#define SALT_T(kc) MT(MOD_LSFT | MOD_LALT, kc)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |----------------------------------------------------------------|
   * |SALT(Tab)| Q| W|  E|  R|  T|  Y|  U|  I|  O|  P|  [| ]|  \  |Del |
   * |----------------------------------------------------------------|
   ...
   * `----------------------------------------------------------------'
   */
[BASE_LAYER] = LAYOUT_65_ansi(
  KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_BSPC, KC_F5, \
  SALT_T(KC_TAB), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL, \
...
[UNICODE_LAYER] = LAYOUT_65_ansi(
  ...
  _______, XP(LOWER_A, UPPER_A), _______, _______, _______, _______, _______, _______, _______, UC_M_LN, XP(LOWER_O, UPPER_O), XP(LOWER_A, UPPER_A), _______, _______, \
  KC_LSFT, _______, _______, _______, _______, _______, _______, UC_M_OS, _______, _______, _______, KC_RSFT, _______, _______, \
