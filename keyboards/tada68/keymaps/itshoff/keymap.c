...
[_BL] = KEYMAP_ANSI(
   ...
   * |     |   |Up |   |   |   |   |   |   |   |   |F21|   |     |Hme |
   * |----------------------------------------------------------------|
   * |      |<- |Dn | ->|   |   |Lft|Dwn|Up|Rght|F23|F22|   F24  |End |
   * |----------------------------------------------------------------|
...
[_CL] = KEYMAP_ANSI(
  ...
  _______,_______, KC_UP,_______,_______, _______,_______,_______,_______,_______,_______, KC_F21,_______, _______,KC_HOME, \
  _______,KC_LEFT,KC_DOWN,KC_RIGHT,_______,_______,KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT, KC_F23, KC_F22,    KC_F24  , KC_END, \
